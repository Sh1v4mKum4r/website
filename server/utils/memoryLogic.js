 ...
 */
const getInitialMemoryState = (playerCount = 2) => {
 ...
 */
const makeMemoryMove = (state, cardIndex, currentPlayer) => {
...
module.exports = { getInitialMemoryState, makeMemoryMove, MEMORY_CARD_EMOJIS };
