// Chain Reaction Game Logic — ES module version
...
export const CHAIN_COLORS = ['R', 'G', 'B', 'Y', 'P', 'C'];
export const ROWS = 9;
export const COLS = 9;

export const getInitialChainBoard = () => {
    return Array(ROWS * COLS).fill(null);
};

export const getCriticalMass = (index) => {
...
export const makeChainMove = (board, index, turn, turnOrder, moveCount) => {
    // Validate index
