...
export const getInitialCheckersBoard = () => {
...
export const getPotentialMoves = (board, index) => {
...
export const getAllPossibleMoves = (board, turn, mustMoveIndex = null) => {
    const allMoves = [];
    let hasJumps = false;
...
export const checkCheckersWinner = (board) => {
    let redCount = 0;
    let blackCount = 0;
...
export const makeCheckersMove = (board, fromIndex, toIndex, turn, mustMoveIndex = null) => {
