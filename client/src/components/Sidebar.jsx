...
const gameRouteMap = { tictactoe: 'tic-tac-toe', connect4: 'connect4', othello: 'othello', checkers: 'checkers', gomoku: 'gomoku', mancala: 'mancala', dotsboxes: 'dots-and-boxes', nim: 'nim', uttt: 'ultimate-tic-tac-toe', chain: 'chain-reaction', memory: 'memory', scribble: 'scribble', imposter: 'imposter-word', wordle: 'wordle' };
const gameNameMap = { tictactoe: 'Tic Tac Toe', connect4: 'Connect 4', othello: 'Othello', checkers: 'Checkers', gomoku: 'Gomoku', mancala: 'Mancala', dotsboxes: 'Dots & Boxes', nim: 'Nim', uttt: 'Ultimate Tic Tac Toe', chain: 'Chain Reaction', memory: 'Memory', scribble: 'Scribble', imposter: 'Imposter Word', wordle: 'Wordle' };
